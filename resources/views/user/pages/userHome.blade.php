                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="{{ ($home && $home->backgroundColor) ? 'col-lg-7' : 'col-lg-8' }} fv-row">
                            <input type="color" name="color" id="color"
                                   class="form-control form-control-lg form-control-solid"
                                   placeholder="Color" value="{{ $home ?  $home->backgroundColor : '#000000' }}"/>
                        ...
                        @if($home && $home->backgroundColor)
                            <div class="col-lg-1 fv-row mt-6">
                                <button class="btn btn-primary " type="button" id="clearColorButton">Remove</button>
                            </div>
                        @endif
                        <!--end::Col-->
                    </div>
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            ...
                            // Form submit olduğunda colorInput değerini null yap
                            // document.getElementById('kt_home_form').addEventListener('submit', function() {
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            ...
                            <input type="text" name="video" id="video"
                                   class="form-control form-control-lg form-control-solid"
                                   placeholder="Watch Video Youtube link" value="{{ $home ? $home->video : '' }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
